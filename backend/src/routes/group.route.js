...
router.delete('/delete/:id', authMiddleware, controller.deleleGroup); //rời nhóm hoặc xóa nhóm
...
router.delete('/:id/deleteMembers', authMiddleware, controller.deleteMember);  //xóa thành viên nhóm
router.patch('/:id/changeRole/:userId', authMiddleware, controller.changeRole); // đổi role thành viên
